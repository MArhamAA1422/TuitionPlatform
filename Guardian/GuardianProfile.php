...
<body>
  ...
  <div class="container">
    ...
    <ul>
      <li><a href="g-job-board.php">Dashboard</a></li>
      <li><a href="newjob.php">New Job</a></li>
      <li><a href="g-job-u.php">Update Job</a></li>
    </ul>
    <br>
    <img src="../images/M-images/5920.jpg" alt="Italian Trulli">
    <br>
    <form action="guardianlogout.php" method="post">
      <input id="btn" type="submit" name="logout" value="Log Out">
    </form>
