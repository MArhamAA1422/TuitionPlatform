...
if (isset($_POST['approve']) && isset($_POST['content_id']) && isset($_POST['content_id1'])) {
    ...
    $que = "INSERT INTO `guardianresponse`(`Tuition_id`, `Tutor_id`, `Status`) VALUES ($fi, $se,'Congratulation,you are selected,we will contact you soon.')";
    mysqli_query($db, $que);
    
    $del = "INSERT INTO `booked`(`Tuition_id`) VALUES ($fi)";
    mysqli_query($db, $del);
