...
<body>
    ...
    <form class="jb form-inline" action="search.php" method="post">
        <div class="jb form-group" style="width: 20%;">
            <label for="subject" placeholder="Subject"></label>
            <input type="text" name="subject" class="form-control" id="subject">
        </div>
         <div>
            <input id="btn btn-primary btn-sm" type="submit" name="find" value="Search">
        </div>   
     </form>
